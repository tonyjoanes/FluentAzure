...
[SuppressMessage(
    ...
    Justification = "The non-generic Result factory class belongs with Result<T>."
)]
public readonly struct Result<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Result{T}"/> struct that succeeded with the specified value.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Result{T}"/> struct that failed with the specified errors.
    /// </summary>
